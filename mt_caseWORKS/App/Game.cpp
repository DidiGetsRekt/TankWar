...
void Game::makePlatforms() {
	...
	for (int i = 0; i < cScreenHeight; i++) {
		platforms.push_back(Vector2i(cScreenWidth-1, i ));
		platforms.push_back(Vector2i(0,i));
	}
	for (int i = 0; i < cScreenWidth; i++) {
		platforms.push_back(Vector2i(i, cScreenHeight-1));
		platforms.push_back(Vector2i(i, 0));
	}
